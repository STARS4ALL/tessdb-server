...
-- stars703
INSERT INTO tess_t (mac_address,valid_since,valid_until,valid_state,model,firmware,authorised,registered,nchannels,zp1,filter1,zp2,filter2,zp3,filter3,zp4,filter4,location_id,observer_id) 
VALUES ('CA:FE:28:BE:CA:13', '2023-12-12 10:00:00+00:00', '2999-12-31 23:59:59+00:00', 'Current', 'TESS4C', 'Nov 28 2022 ?', 0, 'Manual', 4, 20.18, 'UVIR750', 20.28, 'UVIR650', 20.38, 'RGB-R', 20.04, 'RGB-B', -1, -1);
INSERT INTO name_to_mac_t(name, mac_address,valid_since,valid_until,valid_state) 
VALUES ('stars703', 'CA:FE:28:BE:CA:13', '2023-12-12 10:00:00+00:00', '2999-12-31 23:59:59+00:00', 'Current');
-- stars704
INSERT INTO tess_t (mac_address,valid_since,valid_until,valid_state,model,firmware,authorised,registered,nchannels,zp1,filter1,zp2,filter2,zp3,filter3,zp4,filter4,location_id,observer_id) 
VALUES ('CA:FE:28:BE:CA:12', '2023-12-12 10:00:00+00:00', '2999-12-31 23:59:59+00:00', 'Current', 'TESS4C', 'Nov 28 2022 ?', 0, 'Manual', 4, 20.50, 'UVIR750', 20.50, 'UVIR650', 20.50, 'RGB-R', 20.50, 'RGB-B', -1, -1);
INSERT INTO name_to_mac_t(name, mac_address,valid_since,valid_until,valid_state) 
VALUES ('stars704',  'CA:FE:28:BE:CA:12', '2023-12-12 10:00:00+00:00', '2999-12-31 23:59:59+00:00', 'Current');
-- stars705
INSERT INTO tess_t (mac_address,valid_since,valid_until,valid_state,model,firmware,authorised,registered,nchannels,zp1,filter1,zp2,filter2,zp3,filter3,zp4,filter4,location_id,observer_id) 
